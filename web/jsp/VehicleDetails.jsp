...
<%@page import="vehicleView.vehicleDetails"%>
...
<html>
    ...
    <body>
        ...
        <%
            String ITripId= request.getParameter("vehicle");
            vehicleDetails t = new vehicleDetails();
            out.print(t.getVehicleDetails(new BigDecimal(ITripId)));
        %>
    </body>
</html>
