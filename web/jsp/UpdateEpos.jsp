...
<%
    ...
    el.update_in_table(Integer.parseInt(machine_id), user.getTblPlant().getIPlantId().intValue(), Integer.parseInt(terminal_id), Integer.parseInt(Gate_no),Gateway_name, location);
%>