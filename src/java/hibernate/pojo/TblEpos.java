 ...
 */
public class TblEpos  implements java.io.Serializable, Comparable<TblEpos> {
    ...
    public int compareTo(TblEpos e)
    {
        return IGateNo.intValue()-e.IGateNo.intValue();
    }
