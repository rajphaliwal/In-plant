...
//throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    ...
    public String insert_into_table(String v_id,int plant_id,String v_chasis, String v_type,long v_load,int v_owner,String v_permit,Date v_lcnsedate) 
    {
        boolean error_flag=false;
        ...
        try
        {
            ...
            
            {
                ...
                TblTransporter transporter= t.get_tuple(v_owner);
            ...
            if(transporter!=null)
                    vhc.setTblTransporter(transporter);
            else    throw new Exception("Foreign Key Plant_id Dependency Failed ");
